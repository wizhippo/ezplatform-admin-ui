    ...
    public function addSemanticConfig(NodeBuilder $nodeBuilder)
    {
        $nodeBuilder
            ->arrayNode('universal_discovery_widget_module')
                ...
                ->children()
                    ->scalarNode('default_location_id')->setDeprecated('Use configuration.default.starting_location_id instead.')->isRequired()->end()
                    ->arrayNode('configuration')->isRequired()->variablePrototype()->end()
                ->end()
            ->end();
    }
